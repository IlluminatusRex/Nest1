...
function getClients() {
  return [
    { id: 'clientId1', name: 'John Doe', address: '123 Main Street, London' },
    { id: 'clientId2', name: 'Jane Duncan', address: '123 Main Alley, London' },
    { id: 'clientId3', name: 'Thomas Jefferson', address: 'Baker Street 12B, New York' },
  ];
}
